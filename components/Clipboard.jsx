...
export default async function Clipboard({email}) {
    ...
    return (
        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 px-[14px] py-[6px] rounded-[20px] bg-gradient-to-b from-white/50 to-white/50 mt-6 cursor-pointer" onClick={checkWallet}>
