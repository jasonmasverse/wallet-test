    ...
    <>
      <main className='flex flex-col w-full h-[120vh] items-center py-10'>
        ...
        <div className='flex flex-col items-center pt-8 pb-8 text-white'>
          <p className='text-xl font-semibold'>Maschain DevDay II</p>
          <Image src='/devday.webp' width={100} height={100} alt='nft image' className=' mt-8 flex-grow-0 flex-shrink-0 w-[250px] h-[250px] rounded-[18px]'></Image>
